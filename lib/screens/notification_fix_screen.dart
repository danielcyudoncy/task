                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 8.h),
                          Text(
                              'Total Notifications: ${notificationController.totalNotifications.value}'),
                          Text(
                              'Unread Count: ${notificationController.unreadCount.value}'),
                          Text(
                              'Task Assignment Unread: ${notificationController.taskAssignmentUnreadCount.value}'),
                          Text(
                              'Valid Notifications: ${notificationController.validNotifications.length}'),
                        ],
                      ),
                    ),
                  )),
