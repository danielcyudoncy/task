...
class StartupOptimizationService extends GetxService {
  ...
  double _calculateOverallProgress(
      StartupPhase currentPhase, double phaseProgress) {
    const phaseWeights = {
  ...
  Future<void> _saveStartupMetrics() async {
    ...
    try {
      final metrics = StartupMetrics(
        ...
        totalDuration:
            _startupEndTime?.difference(_startupStartTime!) ?? Duration.zero,
      );
...
mixin StartupAwareMixin {
  StartupOptimizationService get startupService =>
      StartupOptimizationService.to;
