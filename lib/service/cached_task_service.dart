...
class CachedTaskService extends GetxService {
  ...
  Stream<Map<String, dynamic>> get taskUpdateStream =>
      _taskUpdateController.stream;
  ...
  Future<Map<String, dynamic>?> getTask(String taskId,
    ...
    try {
      final taskData =
          await _cacheManager.getTaskData(taskId, forceRefresh: forceRefresh);
          ...
          fallback: () async {
            ...
            final stats = {
              ...
              'completed': tasks
                  ...
                  .length,
              'archived':
                  tasks.where((doc) => doc.data()['archived'] == true).length,
  ...
  Future<void> _enhanceTasksWithUserData(
