...
class OfflineDataService extends GetxService {
  ...
  Future<void> cacheData(String type, String id, Map<String, dynamic> data) async {
    try {
      if (_database == null) return;
  ...
  Future<void> storeForSync(String type, String id, Map<String, dynamic> data) async {
    try {
      if (_database == null) return;
      ...
      for (final itemMap in pendingItems) {
        ...
        try {
          ...
          if (success) {
            ...
            // Mark as failed
            await _updateSyncStatus(item.id, SyncStatus.failed, 'Sync operation failed');
          }
        } catch (e) {
