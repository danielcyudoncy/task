...
class AccessControlService extends GetxService {
  ...
  Future<bool> canPerformBulkOperations(String userId) async {
    ...
    try {
      ...
      Get.log(
          'Failed to check bulk operations permission for user $userId: $e');
      return false;
    }
  }
  ...
  Future<FieldPermissions> _getFieldPermissions(String fieldName) async {
    try {
      ...
      final doc =
          await _firestore.collection('field_permissions').doc(fieldName).get();
  ...
  Future<void> setFieldPermissions(FieldPermissions permissions) async {
    ...
    try {
      ...
      Get.log(
          'Successfully updated permissions for field: ${permissions.fieldName}');
    } catch (e) {
  ...
  Future<List<FieldPermissions>> getAllFieldPermissions() async {
    ...
    try {
      final querySnapshot =
          await _firestore.collection('field_permissions').get();
