...
class UIHelpers {
  ...
  static Widget buildEmptyStateIcon(IconData icon, Color color) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: color.withValues(alpha: 1 / 255.0),
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: color.withValues(alpha: 3 / 255.0),
          width: 1,
        ),
      ),
      child: Icon(
  ...
  static Widget buildSection({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: Theme.of(context).brightness == Brightness.dark
              ? Colors.white.withValues(alpha: 1 / 255.0)
              : Colors.grey.withValues(alpha: 2 / 255.0),
        ),
      ),
      child: Column(
  ...
  static Widget buildTag(BuildContext context, String tag, {Color? color}) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: tagColor.withValues(alpha: 1 / 255.0),
        borderRadius: BorderRadius.circular(20),
        border: Border.all(
          color: tagColor.withValues(alpha: 3 / 255.0),
        ),
      ),
      child: Text(
        tag,
