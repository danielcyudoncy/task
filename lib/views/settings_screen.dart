...
class SettingsScreen extends StatelessWidget {
  ...
  Color _getTextColor(BuildContext context) {
    ...
    // Always use the theme's text colors for better consistency
    if (themeController.currentThemeMode.value == AppThemeMode.dark) {
      return colorScheme.onPrimary; // White text on dark backgrounds
    } else {
      return colorScheme.onSurface; // Dark text on light backgrounds
    }
  }
                  ...
                  child: Column(
                    children: [
                      ...
                      const ThemeSelectorWidget(
                        ...
                        subtitle:
                            "Choose your preferred app theme or follow system settings",
                      ),
                      ...
                      if (!AppLocalizations.isLanguageFullySupported(
                          settingsController.selectedLanguage.value))
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  'unsupported_language_note'.trParams({
    ...
    return Card(
      ...
      child: ListTile(
        ...
        title: Text(
          title,
          style: TextStyle(
              color: _getTextColor(context), fontWeight: FontWeight.w500),
        ),
  ...
  Future<void> _showSetPinDialog(
      BuildContext context, AppLockController appLockController) async {
