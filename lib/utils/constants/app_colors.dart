...
class AppColors {
  ...
  static const Color darkBackground = Color(0xFF003080); // Theme dark surface variant
  ...
  static const Color lightSurface = Color(0xFFF0F0F0); // Theme light surface variant
  static const Color primaryContainer = Color(0xFFE8F0FF); // Theme primary container
}
