...
class _LibrarianTaskCardState extends State<LibrarianTaskCard>
                  ...
                  children: [
                    ...
                    if (widget.task.dueDate != null) ...[
                      _buildMetadataChip(
                        ...
                        label:
                            'Due ${dateFormat.format(widget.task.dueDate!.toLocal())}',
                      ),
                    ],
                    if (widget.task.archivedAt != null) ...[
                      _buildMetadataChip(
                        ...
                        label:
                            'Archived ${dateFormat.format(widget.task.archivedAt!.toLocal())}',
                        ...
                        children: [
                          ...
                          if (widget.task.assignedCameraman != null) ...[
                            ...
                            _buildUserAvatar(
                              ...
                              tooltip:
                                  'Cameraman: ${widget.task.assignedCameraman}',
                              isCameraman: true,
                            ),
                          ],
                          ...
                          if (widget.task.assignedLibrarian != null) ...[
                            ...
                            _buildUserAvatar(
                              ...
                              tooltip:
                                  'Librarian: ${widget.task.assignedLibrarian}',
                              isLibrarian: true,
                            ),
                          ],
                        ],
  ...
  String _getCreatorName() {
    try {
      ...
      return widget.task.createdBy.isNotEmpty
