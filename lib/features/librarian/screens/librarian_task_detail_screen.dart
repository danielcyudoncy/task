                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onLongPress: () {
                                Clipboard.setData(
                                    ClipboardData(text: _task.title));
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                            ...
                            Row(
                              children: [
                                ...
                                if (_task.approvalStatus != null &&
                                    _task.approvalStatus != 'pending')
                                  AnimatedContainer(
                                    duration: AppDurations.fastAnimation,
                                    padding: const EdgeInsets.symmetric(
                                      horizontal: 12,
                            ...
                            GestureDetector(
                              onLongPress: () {
                                if (_task.description.isNotEmpty) {
                                  Clipboard.setData(
                                      ClipboardData(text: _task.description));
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                      content: Text(
                        ...
                        child: Column(
                          ...
                          children: [
                            _buildDetailRow(
                              ...
                              label: 'Created',
                              value:
                                  dateFormat.format(_task.timestamp.toLocal()),
                            ),
                            if (_task.dueDate != null) ...[
                              ...
                              _buildDetailRow(
                                ...
                                label: 'Due Date',
                                value:
                                    dateFormat.format(_task.dueDate!.toLocal()),
                              ),
                            ],
                            if (_task.status.toLowerCase() == 'completed' &&
                                _task.lastModified != null) ...[
                              const Divider(height: 24),
                              _buildDetailRow(
                                context,
                                ...
                                label: 'Completed',
                                value: dateFormat
                                    .format(_task.lastModified!.toLocal()),
                              ),
                            ],
                            if (_task.archivedAt != null) ...[
                              ...
                              _buildDetailRow(
                                ...
                                label: 'Archived',
                                value:
                                    '${dateFormat.format(_task.archivedAt!.toLocal())}'
                        ...
                        _buildSection(
                          ...
                          child: Column(
                            ...
                            children: [
                              _buildDetailRow(
                                context,
                                icon: _task.isApproved
                                    ? Icons.check_circle_outline
                                    : Icons.cancel_outlined,
                                label:
                                    _task.isApproved ? 'Approved' : 'Rejected',
                                value: _task.approvalTimestamp != null
                                    ? dateFormat.format(
                                        _task.approvalTimestamp!.toLocal())
                                    : 'Unknown date',
                              ),
                              if (_task.approvedBy != null) ...[
                                ...
                                _buildDetailRowWithWidget(
                                  ...
                                  label: _task.isApproved
                                      ? 'Approved By'
                                      : 'Rejected By',
                                  valueWidget:
                                      _buildAsyncUserName(_task.approvedBy!),
                                ),
                              ],
                              if (_task.approvalReason != null &&
                                  _task.approvalReason!.isNotEmpty) ...[
                                const Divider(height: 24),
                                _buildDetailRow(
                                  context,
